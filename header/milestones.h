...
void energy_drift(int steps=5000, double mass=196.96657 * 103.6, double boltzmann_kb =8.617333262 * pow(10,-5),double  timestep = 15, double rc=5, double sigma=1, double eps=1);