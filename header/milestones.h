...
void milestone8(int argc, char *argv[], int steps = 3000 , double mass = 196.96657 * 103.6, double  timestep = 1,double rc =  5, int save_every = 1000, double sigma=1, double eps=1);