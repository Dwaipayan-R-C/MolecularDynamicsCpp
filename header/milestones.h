...
void milestone7(int steps = 100000, double mass = 196.96657 * 103.6, double delQ = 10, double boltzmann_kb =8.617333262 * pow(10,-5),double  timestep = 2,double rc = 5, int tau = 1000, int save_every = 1000,double sigma=1, double eps=1);
void milestone7_heatCap(int steps = 4000, double mass = 196.96657 * 103.6,  double boltzmann_kb =8.617333262 * pow(10,-5),double  timestep = 2,double rc = 5, int tau = 1000, int save_every = 1000,double sigma=1, double eps=1);
void milestone8(int argc, char *argv[], int steps = 20000 , double mass = 196.96657 * 103.6, double  timestep = 1,double rc =  5, int save_every = 1000, double sigma=1, double eps=1);
void lj_potential_distance(int steps = 13000,double mass=1,double sigma=1, double eps=1, int save_gap=10, double rc =5);
void energy_drift(int steps=5000, double mass=196.96657 * 103.6, double boltzmann_kb =8.617333262 * pow(10,-5),double  timestep = 0.5, double rc=5, double sigma=1, double eps=1);